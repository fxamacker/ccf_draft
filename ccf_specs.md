...
- a CCF-based protocol for encoding unsorted fields might want to specify that encoders are not required to produce deterministic encodings of the values (if speed or compatibility is higher priority than "Deterministic CCF Encoding Requirements"). 
